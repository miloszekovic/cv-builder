...
const pageNums = `<span class="pageNumber"></span> of <span class="totalPages"></span>`;
const pageLabel = `Page ${pageNums}`;
...
<span style="font-size:8px;font-style:italic;color:#64748b;">${pageLabel}</span>
</div>`,
    ),
...
<span style="font-size:8px;font-weight:600;color:#475569;">${pageLabel}</span>
</div>`,
    ),
...
<span style="font-size:7px;font-weight:400;letter-spacing:0.14em;color:#9ca3af;">${pageLabel}</span>
</div>`,
    ),
...
<span style="font-size:7px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:#94a3b8;">${pageLabel}</span>
</div>`,
    ),
...
<span style="font-size:8px;font-weight:700;color:${accent};letter-spacing:0.04em;">${pageLabel}</span>
</div>`,
    ),
...
<span style="font-size:8px;color:#52525b;">${pageLabel}</span>
</div>`,
    ),
...
<span style="font-size:7px;font-weight:300;letter-spacing:0.22em;text-transform:uppercase;color:#cbd5e1;">${pageLabel}</span>
</div>`,
    ),
};
