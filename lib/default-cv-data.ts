...
export const defaultSkillLibraryTags: Record<SkillCategoryId, string[]> = {
  ...
  cms: ["WordPress", "ACF", "WPML", "Yoast SEO", "Headless CMS"],
  ...
  return {
    ...
    sidebar: {
      ...
      hobbies: [
        "Film photography",
        "Gravel cycling",
        "Home espresso experiments",
        "Indie game jams",
        "Local meetups",
      ],
      hobbiesText:
        "I contribute small patches to OSS UI libraries and occasionally mentor bootcamp graduates through mock interviews and portfolio reviews.",
    },
  };
};
